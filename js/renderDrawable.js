...
var renderDrawable = function(drawable) {
	...
	var vPosition = gl.getAttribLocation(programInfo.program, "vPosition"); // TODO: maybe move this into programInfo?
    gl.vertexAttribPointer(vPosition, 4, gl.FLOAT, false, 0, 0);
   	gl.enableVertexAttribArray(vPosition);

    gl.uniformMatrix4fv(programInfo.worldMatLocation, false, flatten(drawable.worldMatrix));      // Pass the world matrix of the current object to the shader.
